    ...
    <div className="mt-8 flex flex-col gap-4 lg:mt-0">
      ...
      <div className="flex flex-col gap-3">
        ...
        <Button
          ...
          variant="secondary"
          disabled={!email}
          className="h-10 w-full px-0 text-sm font-medium text-neutral-900 transition-transform hover:text-neutral-900 disabled:pointer-events-auto! disabled:cursor-not-allowed! disabled:opacity-50"
        >
          Get started free
        </Button>
      </div>
      <div className="flex items-center justify-center gap-3 pt-0 pb-6 md:justify-start lg:pt-2 lg:pb-0">
