...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{" "}
      <ArrowDown2
        className="relative top-px size-4 transition duration-300 group-data-open/navigation-menu-trigger:rotate-180 group-data-popup-open/navigation-menu-trigger:rotate-180"
        aria-hidden="true"
      />
    </NavigationMenuPrimitive.Trigger>
  );
