...
These instructions are essential for ensuring accurate and helpful responses when interacting with the Figma MCP SERVER. Follow these guidelines strictly when working with Figma MCP server.

# GitHub Copilot Instructions for shadcn/ui Project
